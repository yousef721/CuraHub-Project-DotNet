...
{
    public class ClinicReceptionistCreateEditVM
    {
        [Required]
        ...
        public CrudOption? CrudClinicReceptionistOption { get; set; } = CrudOption.Creating;
        ...
        public ClinicReceptionistCreateEditVM()
        {
            this.Id = 0;
            ...
            this.ProfilePicture = "clinicRecepiatist.jpg";
            ...
            this.CrudClinicReceptionistOption = CrudOption.Creating;
        }
