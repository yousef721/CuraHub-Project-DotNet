...
{
    public class RequestMedicalAnalysisLabReceptionistConfig : IEntityTypeConfiguration<RequestMedicalAnalysisLabReceptionist>
    {
        public void Configure(EntityTypeBuilder<RequestMedicalAnalysisLabReceptionist> builder)
        {
            ...
            builder.HasOne(e => e.MedicalAnalysisLabBranch)
               .WithMany(e => e.RequestMedicalAnalysisReceptionists)
               .HasForeignKey(e => e.MedicalAnalysisLabBranchId);


            builder.ToTable("RequestMedicalAnalysisLabReceptionists", "MedicalAnalysisLab");
