...
{
    public class ClinicReceptionistConfig : IEntityTypeConfiguration<ClinicReceptionist>
    {
        public void Configure(EntityTypeBuilder<ClinicReceptionist> builder)
        {
            ...
            builder.HasOne(e => e.Doctor)
               .WithMany(e => e.ClinicReceptionists)
               .HasForeignKey(e => e.DoctorId);


            builder.ToTable(name: " ClinicReceptionists", schema: "Clinic");
