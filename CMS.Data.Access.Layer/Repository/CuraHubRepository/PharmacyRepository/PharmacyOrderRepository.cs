...
{
    public class PharmacyOrderRepository : Repository<PharmacyOrder>, IPharmacyOrderRepository
    {
        public PharmacyOrderRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
