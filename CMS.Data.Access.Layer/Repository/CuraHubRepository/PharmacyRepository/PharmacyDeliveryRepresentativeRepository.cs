...
{
    public class PharmacyDeliveryRepresentativeRepository : Repository<PharmacyDeliveryRepresentative>, IPharmacyDeliveryRepresentativeRepository
    {
        public PharmacyDeliveryRepresentativeRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
