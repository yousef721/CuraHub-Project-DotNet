...
{
    public class ClinicReceptionistRepository : Repository<ClinicReceptionist>, IClinicReceptionistRepository
    {
        public ClinicReceptionistRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
