...
{
    public class MedicalAnalysisLabReceptionistRepository : Repository<MedicalAnalysisLabReceptionist>, IMedicalAnalysisLabReceptionistRepository
    {
        public MedicalAnalysisLabReceptionistRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
