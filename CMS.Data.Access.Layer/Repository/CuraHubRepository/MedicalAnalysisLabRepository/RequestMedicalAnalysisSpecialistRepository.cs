...
{
    public class RequestMedicalAnalysisSpecialistRepository : Repository<RequestMedicalAnalysisSpecialist>, IRequestMedicalAnalysisSpecialistRepository
    {
        public RequestMedicalAnalysisSpecialistRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
