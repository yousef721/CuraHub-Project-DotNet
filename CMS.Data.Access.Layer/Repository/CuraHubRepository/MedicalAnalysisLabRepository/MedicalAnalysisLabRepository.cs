...
{
    public class MedicalAnalysisLabRepository : Repository<MedicalAnalysisLab> , IMedicalAnalysisLabRepository
    {
        public MedicalAnalysisLabRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
