...
{
    public class MedicalAnalysisSpecialistRepository : Repository<MedicalAnalysisSpecialist> , IMedicalAnalysisSpecialistRepository
    {
        public MedicalAnalysisSpecialistRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
